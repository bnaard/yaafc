...
- **If a task is not completed**, add a comment in `TASK.md` with the reason and the date.
- **If a task is not relevant anymore**, add a comment in `TASK.md` with the reason and the date.
